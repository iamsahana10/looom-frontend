  ...
  return (
    <div className="min-h-screen e-full flex-col items-center py-6 px-4">
      <div className="w-full max-180 flex items-center mb-4 strink-0">
        <button
          onClick={() => navigate(-1)}
          className="w-8 h-8 flex items-center justify-center rounded-full hover:bg-black/10 transition-all duration-150"
        >
          <ArrowLeft size={18} text-gray-800 />
        </button>
        <h1 className="text-[15px] font-midum flex-1 text-center p-r-a">
          Thread
        </h1>
      </div>
      <div className="w-full max-w-180 bg-white border-black/10 rounded-4xl shadow-sm">
        <PostCard post={post} viewPost />
        <div className="max-5 border-t border-black/10" />
        {/*separator*/}
        <div className="px-1">
        ...
        {replies.length == 0 && (
          <div className="flex-col item-center justify-center px-6 py-10 text-center">
            <p className="text-sm text-gray-400 text-leading-relaxed">
